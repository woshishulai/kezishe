...
export const goodsListAPi = (params) =>
    instance.post(
        `Web/Auction/Query?Stype=${params.Stype}&Cate1=${params.Cate1}&Cate2=${params.Cate2}&Lid=${params.Lid}&AuctionStatuses=${params.AuctionStatuses}&AuctionBrands=${params.AuctionBrands}&CategoryIds=${params.CategoryIds}&Grades=${params.Grades}&Sort=${params.Sort}&DateStart=${params.DateStart}&DateEnd=${params.DateEnd}&TimeRange=${params.TimeRange}&PriceRange=${params.PriceRange}&PageSize=${params.PageSize}&PageIndex=${params.PageIndex}`
    );
// export const goodsListAPi = (params) =>
//     instance.post(
